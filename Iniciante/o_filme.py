def main():
    """
    Bem-vindo à 3a Maratona de Programação Júnior da UFFS. Esperamos sinceramente
    ...
    também que às 17:30 os juízes automáticos serão desligados e a competição entrará
    em modo blind, de modo que todas as submissões neste período só começarão a ser
    julgadas às 18:10. Por favor, fique conosco até o fim da competição, trabalhando
    nas soluções dos problemas até o último minuto, pois, enquanto a competição ainda
    está ocorrendo, sempre há esperança!
    ...
    respeito a Universidade: com as aulas, com a biblioteca, com os projetos de
    ...
    os quais, fornecidos com exatos dois dígitos após o ponto separador decimal, representam
