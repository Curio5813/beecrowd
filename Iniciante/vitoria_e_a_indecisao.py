def main():
    ...
    Computação, há dias que ela diz que quer alguma Engenharia, em outros ela quer qualquer
    ...
    Entrada
    A primeira linha de entrada contém um inteiro 1 ≤ n ≤ 2000, que representa a quantidade de cursos
    a serem considerados. Cada uma das próximas n linhas irá conter uma cadeia de caracteres S,
    1 ≤ |S| ≤ 100, representando o nome do curso.
