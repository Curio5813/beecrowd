...
def ones(l1):
    ...
    não divisível por 2 ou por 5, algum múltiplo de n que deve
    ser um número que é uma sequência de algarismos 1. Você
    deve então calcular e mostrar quantos dígitos tem o menor
    múltiplo de n que tem todos seus dígitos iguais a 1.
    :param l1:
    :return:
    """
    num, str_1, l2 = [], "", []
